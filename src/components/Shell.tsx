...
export function Shell() {
  return <MotionProvider><ShellContent /></MotionProvider>
}
...
function ShellContent() {
  ...
  return <div className="site-shell" data-motion={motion}>
    <a className="skip-link" href="#main" onClick={(event) => {
      event.preventDefault()
      document.getElementById('main')?.focus()
    }}>跳到主要內容</a>
    <header className="site-header"><div className="header-row"><Link to="/" className="brand"><Icon name="book" />人類使用說明書</Link><div className="header-tools"><MotionToggle /><Link to="/about" className="header-about">關於</Link></div></div><div className="ornament" aria-hidden="true"><span>✦</span></div></header>
